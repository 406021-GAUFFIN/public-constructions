...
-- Insert contructions
--
INSERT INTO CONSTRUCTION (ID, OWNER_ID, PLOT_ID, PLANNED_START_DATE, ACTUAL_START_DATE, PLANNED_END_DATE, ACTUAL_END_DATE, DESCRIPTION, APPROVED_BY_MUNICIPALITY, PROJECT_NAME, PROJECT_ADDRESS, CONSTRUCTION_STATUS)
VALUES (1, 1, 101, '2024-01-15', '2024-01-20', '2024-12-01', NULL, 'Construcción de vivienda unifamiliar de dos plantas.', TRUE, 'Casa Familiar López', 'Calle Falsa 123', 'IN_PROGRESS');
