...
INSERT INTO WORKER (CONTACT_ID, ADDRESS, NAME, LAST_NAME, CUIL, DOCUMENT, SPECIALITY_TYPE, CONSTRUCTION_ID, AVAIBLE_TO_WORK) VALUES(1, 'Siempre Viva 123', 'Homero', 'Simpson', 20324345676, NULL, 800, 808, TRUE);
INSERT INTO WORKER (CONTACT_ID, ADDRESS, NAME, LAST_NAME, CUIL, DOCUMENT, SPECIALITY_TYPE, CONSTRUCTION_ID, AVAIBLE_TO_WORK) VALUES(1, 'Estadio Libertadores de America', 'Ricardo Enrique', 'Bochini', 20777777776, NULL, 805, 808, TRUE);
INSERT INTO WORKER (CONTACT_ID, ADDRESS, NAME, LAST_NAME, CUIL, DOCUMENT, SPECIALITY_TYPE, CONSTRUCTION_ID, AVAIBLE_TO_WORK) VALUES(1, 'Esquina Libertad', 'Ciro', 'Martinez', 203152045276, NULL, 801, 808, FALSE);